...
import Foundation
 ...
 class MockEventVisitorProtocol: EventVisitorProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    processSelectedConnectionChanged(event: SelectedConnectionChanged)
    """,
            parameters: (event),
            escapingParameters: (event),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    processSelectedNodeUpdated(event: SelectedNodeChangedEvent)
    """,
            parameters: (event),
            escapingParameters: (event),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.processSelectedNodeUpdated(event: event))
    ...
    """, parameterMatchers: matchers))
        ...
        func processSelectedNodeUpdated<M1: Cuckoo.Matchable>(event: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(SelectedNodeChangedEvent)> where M1.MatchedType == SelectedNodeChangedEvent {
            let matchers: [Cuckoo.ParameterMatcher<(SelectedNodeChangedEvent)>] = [wrap(matchable: event) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockEventVisitorProtocol.self, method:
    """
    processSelectedNodeUpdated(event: SelectedNodeChangedEvent)
    """, parameterMatchers: matchers))
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func processSelectedNodeUpdated<M1: Cuckoo.Matchable>(event: M1) -> Cuckoo.__DoNotUse<(SelectedNodeChangedEvent), Void> where M1.MatchedType == SelectedNodeChangedEvent {
            let matchers: [Cuckoo.ParameterMatcher<(SelectedNodeChangedEvent)>] = [wrap(matchable: event) { $0 }]
            return cuckoo_manager.verify(
    """
    processSelectedNodeUpdated(event: SelectedNodeChangedEvent)
...
import UIKit
 ...
 class MockUnsupportedVersionPresentable: UnsupportedVersionPresentable, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    presentUnsupportedVersion(for: SupportedVersionData, on: UIWindow?, animated: Bool)
    """,
     ...
     struct __StubbingProxy_UnsupportedVersionPresentable: Cuckoo.StubbingProxy {
        ...
        func presentUnsupportedVersion<M1: Cuckoo.Matchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.Matchable>(for data: M1, on window: M2, animated: M3) -> Cuckoo.ProtocolStubNoReturnFunction<(SupportedVersionData, UIWindow?, Bool)> where M1.MatchedType == SupportedVersionData, M2.OptionalMatchedType == UIWindow, M3.MatchedType == Bool {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockUnsupportedVersionPresentable.self, method:
    """
    presentUnsupportedVersion(for: SupportedVersionData, on: UIWindow?, animated: Bool)
    """, parameterMatchers: matchers))
        }
 ...
 class MockWebPresentingViewProtocol: WebPresentingViewProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_WebPresentingViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didStartLoading() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockWebPresentingViewProtocol.self, method:
    """
    didStartLoading()
    """, parameterMatchers: matchers))
        }
...
@testable import SoraPassport
 ...
 class MockAboutViewProtocol: AboutViewProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didReceive(optionViewModels: [AboutOptionViewModelProtocol])
    """,
     ...
     struct __StubbingProxy_AboutViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didReceive<M1: Cuckoo.Matchable>(optionViewModels: M1) -> Cuckoo.ProtocolStubNoReturnFunction<([AboutOptionViewModelProtocol])> where M1.MatchedType == [AboutOptionViewModelProtocol] {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockAboutViewProtocol.self, method:
    """
    didReceive(optionViewModels: [AboutOptionViewModelProtocol])
    """, parameterMatchers: matchers))
        }
    ...
    """,
     ...
     struct __StubbingProxy_AboutPresenterProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockAboutPresenterProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockAboutWireframeProtocol: AboutWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_AboutWireframeProtocol: Cuckoo.StubbingProxy {
        ...
        func showWeb<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable>(url: M1, from view: M2, style: M3) -> Cuckoo.ProtocolStubNoReturnFunction<(URL, ControllerBackedProtocol, WebPresentableStyle)> where M1.MatchedType == URL, M2.MatchedType == ControllerBackedProtocol, M3.MatchedType == WebPresentableStyle {
            let matchers: [Cuckoo.ParameterMatcher<(URL, ControllerBackedProtocol, WebPresentableStyle)>] = [wrap(matchable: url) { $0.0 }, wrap(matchable: view) { $0.1 }, wrap(matchable: style) { $0.2 }]
            return .init(stub: cuckoo_manager.createStub(for: MockAboutWireframeProtocol.self, method:
    """
    showWeb(url: URL, from: ControllerBackedProtocol, style: WebPresentableStyle)
    """, parameterMatchers: matchers))
        }
...
@testable import SoraPassport
 ...
 class MockAccountConfirmInteractorOutputProtocol: AccountConfirmInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    """, parameterMatchers: matchers))
        ...
        func didReceive<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Swift.Error)> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockAccountConfirmInteractorOutputProtocol.self, method:
    """
    didReceive(error: Swift.Error)
    """, parameterMatchers: matchers))
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func didReceive<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.__DoNotUse<(Swift.Error), Void> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return cuckoo_manager.verify(
    """
    didReceive(error: Swift.Error)
 ...
 class MockAccountConfirmWireframeProtocol: AccountConfirmWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    proceed(from: AccountConfirmViewProtocol?)
    """,
            parameters: (view),
...
import SoraFoundation
 ...
 class MockAccountCreatePresenterProtocol: AccountCreatePresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.restoredApp())
    ...
    """, parameterMatchers: matchers))
        ...
        func restoredApp() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockAccountCreatePresenterProtocol.self, method:
    """
    restoredApp()
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func restoredApp() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    restoredApp()
 ...
 class MockAccountCreateInteractorOutputProtocol: AccountCreateInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didReceive(metadata: AccountCreationMetadata)
    """,
            parameters: (metadata),
    ...
    return cuckoo_manager.call(
    """
    didReceiveMnemonicGeneration(error: Swift.Error)
    """,
            parameters: (error),
            escapingParameters: (error),
            superclassCall:
    ...
    """, parameterMatchers: matchers))
        ...
        func didReceiveMnemonicGeneration<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Swift.Error)> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockAccountCreateInteractorOutputProtocol.self, method:
    """
    didReceiveMnemonicGeneration(error: Swift.Error)
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func didReceiveMnemonicGeneration<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.__DoNotUse<(Swift.Error), Void> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return cuckoo_manager.verify(
    """
    didReceiveMnemonicGeneration(error: Swift.Error)
 ...
 class MockAccountCreateWireframeProtocol: AccountCreateWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    confirm(from: AccountCreateViewProtocol?, request: AccountCreationRequest, metadata: AccountCreationMetadata)
    """,
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.authorize())
    ...
    """, parameterMatchers: matchers))
        ...
        func authorize() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockAccountCreateWireframeProtocol.self, method:
    """
    authorize()
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func authorize() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    authorize()
 ...
 class MockAuthorizable: Authorizable, Cuckoo.ProtocolMock {
    
     typealias MocksType = Authorizable
    
     typealias Stubbing = __StubbingProxy_Authorizable
     typealias Verification = __VerificationProxy_Authorizable

     let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    
    private var __defaultImplStub: Authorizable?

     func enableDefaultImplementation(_ stub: Authorizable) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    """,
     ...
     struct __StubbingProxy_Authorizable: Cuckoo.StubbingProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        ...
        func authorize() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockAuthorizable.self, method:
    """
    authorize()
    """, parameterMatchers: matchers))
        }
     ...
     struct __VerificationProxy_Authorizable: Cuckoo.VerificationProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        private let callMatcher: Cuckoo.CallMatcher
        private let sourceLocation: Cuckoo.SourceLocation
 ...
 class AuthorizableStub: Authorizable {
...
import SoraFoundation
 ...
 class MockAccountImportViewProtocol: AccountImportViewProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    setSource(type: AccountImportSource)
    """,
            parameters: (type),
    ...
    return cuckoo_manager.call(
    """
    setName(viewModel: InputViewModelProtocol)
    """,
            parameters: (viewModel),
            escapingParameters: (viewModel),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    setDerivationPath(viewModel: InputViewModelProtocol)
    """,
            parameters: (viewModel),
            escapingParameters: (viewModel),
            superclassCall:
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.dissmissPresentedController())
    ...
    """, parameterMatchers: matchers))
        ...
        func dissmissPresentedController() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockAccountImportViewProtocol.self, method:
    """
    dissmissPresentedController()
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func dissmissPresentedController() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    dissmissPresentedController()
 ...
 class MockAccountImportPresenterProtocol: AccountImportPresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.openSourceTypeView())
    ...
    """, parameterMatchers: matchers))
        ...
        func openSourceTypeView() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockAccountImportPresenterProtocol.self, method:
    """
    openSourceTypeView()
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func openSourceTypeView() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    openSourceTypeView()
 ...
 class MockAccountImportInteractorInputProtocol: AccountImportInteractorInputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    importAccountWithMnemonic(request: AccountImportMnemonicRequest)
    """,
            parameters: (request),
    ...
    return cuckoo_manager.call(
    """
    importAccountWithSeed(request: AccountImportSeedRequest)
    """,
            parameters: (request),
            escapingParameters: (request),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    importAccountWithKeystore(request: AccountImportKeystoreRequest)
    """,
            parameters: (request),
            escapingParameters: (request),
            superclassCall:
 ...
 class MockAccountImportInteractorOutputProtocol: AccountImportInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didReceiveAccountImport(metadata: AccountImportMetadata)
    """,
            parameters: (metadata),
            escapingParameters: (metadata),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    didReceiveAccountImport(error: Swift.Error)
    """,
            parameters: (error),
            escapingParameters: (error),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    didSuggestKeystore(text: String, preferredInfo: AccountImportPreferredInfo?)
    """,
    ...
    """, parameterMatchers: matchers))
        ...
        func didReceiveAccountImport<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Swift.Error)> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockAccountImportInteractorOutputProtocol.self, method:
    """
    didReceiveAccountImport(error: Swift.Error)
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func didReceiveAccountImport<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.__DoNotUse<(Swift.Error), Void> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return cuckoo_manager.verify(
    """
    didReceiveAccountImport(error: Swift.Error)
 ...
 class MockAccountImportWireframeProtocol: AccountImportWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    proceed(from: AccountImportViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
     ...
     func showAccountImportSourceSelector(from controller: UIViewController, title: String, sourceTypes: [AccountImportSource], selectedIndex: Int, delegate: SourceSelectorViewDelegate)  {
        
    return cuckoo_manager.call(
    """
    showAccountImportSourceSelector(from: UIViewController, title: String, sourceTypes: [AccountImportSource], selectedIndex: Int, delegate: SourceSelectorViewDelegate)
    """,
            parameters: (controller, title, sourceTypes, selectedIndex, delegate),
            escapingParameters: (controller, title, sourceTypes, selectedIndex, delegate),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showAccountImportSourceSelector(from: controller, title: title, sourceTypes: sourceTypes, selectedIndex: selectedIndex, delegate: delegate))
    ...
    """, parameterMatchers: matchers))
        ...
        func showAccountImportSourceSelector<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable, M4: Cuckoo.Matchable, M5: Cuckoo.Matchable>(from controller: M1, title: M2, sourceTypes: M3, selectedIndex: M4, delegate: M5) -> Cuckoo.ProtocolStubNoReturnFunction<(UIViewController, String, [AccountImportSource], Int, SourceSelectorViewDelegate)> where M1.MatchedType == UIViewController, M2.MatchedType == String, M3.MatchedType == [AccountImportSource], M4.MatchedType == Int, M5.MatchedType == SourceSelectorViewDelegate {
            let matchers: [Cuckoo.ParameterMatcher<(UIViewController, String, [AccountImportSource], Int, SourceSelectorViewDelegate)>] = [wrap(matchable: controller) { $0.0 }, wrap(matchable: title) { $0.1 }, wrap(matchable: sourceTypes) { $0.2 }, wrap(matchable: selectedIndex) { $0.3 }, wrap(matchable: delegate) { $0.4 }]
            return .init(stub: cuckoo_manager.createStub(for: MockAccountImportWireframeProtocol.self, method:
    """
    showAccountImportSourceSelector(from: UIViewController, title: String, sourceTypes: [AccountImportSource], selectedIndex: Int, delegate: SourceSelectorViewDelegate)
    """, parameterMatchers: matchers))
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func showAccountImportSourceSelector<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable, M3: Cuckoo.Matchable, M4: Cuckoo.Matchable, M5: Cuckoo.Matchable>(from controller: M1, title: M2, sourceTypes: M3, selectedIndex: M4, delegate: M5) -> Cuckoo.__DoNotUse<(UIViewController, String, [AccountImportSource], Int, SourceSelectorViewDelegate), Void> where M1.MatchedType == UIViewController, M2.MatchedType == String, M3.MatchedType == [AccountImportSource], M4.MatchedType == Int, M5.MatchedType == SourceSelectorViewDelegate {
            let matchers: [Cuckoo.ParameterMatcher<(UIViewController, String, [AccountImportSource], Int, SourceSelectorViewDelegate)>] = [wrap(matchable: controller) { $0.0 }, wrap(matchable: title) { $0.1 }, wrap(matchable: sourceTypes) { $0.2 }, wrap(matchable: selectedIndex) { $0.3 }, wrap(matchable: delegate) { $0.4 }]
            return cuckoo_manager.verify(
    """
    showAccountImportSourceSelector(from: UIViewController, title: String, sourceTypes: [AccountImportSource], selectedIndex: Int, delegate: SourceSelectorViewDelegate)
...
@testable import SoraPassport
 ...
 class MockLanguageSelectionViewProtocol: LanguageSelectionViewProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_LanguageSelectionViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didReload() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockLanguageSelectionViewProtocol.self, method:
    """
    didReload()
    """, parameterMatchers: matchers))
        }
 ...
 class MockLanguageSelectionPresenterProtocol: LanguageSelectionPresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_LanguageSelectionPresenterProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockLanguageSelectionPresenterProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
    ...
    """,
     ...
     struct __StubbingProxy_LanguageSelectionInteractorInputProtocol: Cuckoo.StubbingProxy {
        ...
        func load() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockLanguageSelectionInteractorInputProtocol.self, method:
    """
    load()
    """, parameterMatchers: matchers))
        }
 ...
 class MockLanguageSelectionInteractorOutputProtocol: LanguageSelectionInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didLoad(selectedLanguage: Language)
    """,
    ...
    """,
     ...
     struct __StubbingProxy_LanguageSelectionInteractorOutputProtocol: Cuckoo.StubbingProxy {
        ...
        func didLoad<M1: Cuckoo.Matchable>(selectedLanguage: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Language)> where M1.MatchedType == Language {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockLanguageSelectionInteractorOutputProtocol.self, method:
    """
    didLoad(selectedLanguage: Language)
    """, parameterMatchers: matchers))
        }
 ...
 class MockChildPresenterProtocol: ChildPresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_ChildPresenterProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockChildPresenterProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
...
import Foundation
 ...
 class MockInvitationHandlePresenterProtocol: InvitationHandlePresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_InvitationHandlePresenterProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockInvitationHandlePresenterProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockInvitationHandleInteractorInputProtocol: InvitationHandleInteractorInputProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_InvitationHandleInteractorInputProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockInvitationHandleInteractorInputProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockInvitationHandleInteractorOutputProtocol: InvitationHandleInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didReceiveUserDataProvider(error: Swift.Error)
    """,
            parameters: (error),
            escapingParameters: (error),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    didApply(invitationCode: String)
    """,
            parameters: (invitationCode),
            escapingParameters: (invitationCode),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    didReceiveInvitationApplication(error: Swift.Error, of: String)
    """,
     ...
     struct __StubbingProxy_InvitationHandleInteractorOutputProtocol: Cuckoo.StubbingProxy {
        ...
        func didReceive<M1: Cuckoo.Matchable>(userData: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(UserData)> where M1.MatchedType == UserData {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockInvitationHandleInteractorOutputProtocol.self, method:
    """
    didReceive(userData: UserData)
    """, parameterMatchers: matchers))
        }
        ...
        func didReceiveUserDataProvider<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Swift.Error)> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockInvitationHandleInteractorOutputProtocol.self, method:
    """
    didReceiveUserDataProvider(error: Swift.Error)
    ...
    """, parameterMatchers: matchers))
        ...
        func didReceiveInvitationApplication<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(error: M1, of code: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(Swift.Error, String)> where M1.MatchedType == Swift.Error, M2.MatchedType == String {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error, String)>] = [wrap(matchable: error) { $0.0 }, wrap(matchable: code) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockInvitationHandleInteractorOutputProtocol.self, method:
    """
    didReceiveInvitationApplication(error: Swift.Error, of: String)
    """, parameterMatchers: matchers))
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func didReceiveUserDataProvider<M1: Cuckoo.Matchable>(error: M1) -> Cuckoo.__DoNotUse<(Swift.Error), Void> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return cuckoo_manager.verify(
    """
    didReceiveUserDataProvider(error: Swift.Error)
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func didReceiveInvitationApplication<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(error: M1, of code: M2) -> Cuckoo.__DoNotUse<(Swift.Error, String), Void> where M1.MatchedType == Swift.Error, M2.MatchedType == String {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error, String)>] = [wrap(matchable: error) { $0.0 }, wrap(matchable: code) { $0.1 }]
            return cuckoo_manager.verify(
    """
    didReceiveInvitationApplication(error: Swift.Error, of: String)
 ...
 class MockInvitationHandleWireframeProtocol: InvitationHandleWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_InvitationHandleWireframeProtocol: Cuckoo.StubbingProxy {
        ...
        func present<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(message: M1, title: M2, closeAction: M3, from view: M4) -> Cuckoo.ProtocolStubNoReturnFunction<(String?, String?, String?, ControllerBackedProtocol?)> where M1.OptionalMatchedType == String, M2.OptionalMatchedType == String, M3.OptionalMatchedType == String, M4.OptionalMatchedType == ControllerBackedProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(String?, String?, String?, ControllerBackedProtocol?)>] = [wrap(matchable: message) { $0.0 }, wrap(matchable: title) { $0.1 }, wrap(matchable: closeAction) { $0.2 }, wrap(matchable: view) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockInvitationHandleWireframeProtocol.self, method:
    """
    present(message: String?, title: String?, closeAction: String?, from: ControllerBackedProtocol?)
    """, parameterMatchers: matchers))
        }
...
import UIKit
 ...
 class MockMainTabBarViewProtocol: MainTabBarViewProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didReplaceView(for: UIViewController, for: Int)
    """,
     ...
     struct __StubbingProxy_MainTabBarViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didReplaceView<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(for newView: M1, for index: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(UIViewController, Int)> where M1.MatchedType == UIViewController, M2.MatchedType == Int {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockMainTabBarViewProtocol.self, method:
    """
    didReplaceView(for: UIViewController, for: Int)
    """, parameterMatchers: matchers))
        }
 ...
 class MockMainTabBarPresenterProtocol: MainTabBarPresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_MainTabBarPresenterProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockMainTabBarPresenterProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockMainTabBarInteractorInputProtocol: MainTabBarInteractorInputProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_MainTabBarInteractorInputProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockMainTabBarInteractorInputProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockMainTabBarInteractorOutputProtocol: MainTabBarInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didRequestMigration(with: MigrationServiceProtocol)
    """,
            parameters: (service),
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.didUserChange())
     ...
     struct __StubbingProxy_MainTabBarInteractorOutputProtocol: Cuckoo.StubbingProxy {
        ...
        func didReloadSelectedAccount() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockMainTabBarInteractorOutputProtocol.self, method:
    """
    didReloadSelectedAccount()
    """, parameterMatchers: matchers))
        }
    ...
    """, parameterMatchers: matchers))
        ...
        func didUserChange() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockMainTabBarInteractorOutputProtocol.self, method:
    """
    didUserChange()
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func didUserChange() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    didUserChange()
 ...
 class MockMainTabBarWireframeProtocol: MainTabBarWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    showNewWalletView(on: MainTabBarViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    presentAccountImport(on: MainTabBarViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    presentClaim(on: MainTabBarViewProtocol?, with: MigrationServiceProtocol)
    """,
    ...
    return cuckoo_manager.call(
    """
    removeClaim(on: MainTabBarViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    showTransactionSuccess(on: MainTabBarViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    recreateWalletViewController(on: MainTabBarViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.recreateWalletViewController(on: view))
    ...
    """,
     ...
     struct __StubbingProxy_MainTabBarWireframeProtocol: Cuckoo.StubbingProxy {
        ...
        func showNewWalletView<M1: Cuckoo.OptionalMatchable>(on view: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(MainTabBarViewProtocol?)> where M1.OptionalMatchedType == MainTabBarViewProtocol {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockMainTabBarWireframeProtocol.self, method:
    """
    showNewWalletView(on: MainTabBarViewProtocol?)
    """, parameterMatchers: matchers))
        }
    ...
    """, parameterMatchers: matchers))
        ...
        func recreateWalletViewController<M1: Cuckoo.OptionalMatchable>(on view: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(MainTabBarViewProtocol?)> where M1.OptionalMatchedType == MainTabBarViewProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(MainTabBarViewProtocol?)>] = [wrap(matchable: view) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockMainTabBarWireframeProtocol.self, method:
    """
    recreateWalletViewController(on: MainTabBarViewProtocol?)
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func recreateWalletViewController<M1: Cuckoo.OptionalMatchable>(on view: M1) -> Cuckoo.__DoNotUse<(MainTabBarViewProtocol?), Void> where M1.OptionalMatchedType == MainTabBarViewProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(MainTabBarViewProtocol?)>] = [wrap(matchable: view) { $0 }]
            return cuckoo_manager.verify(
    """
    recreateWalletViewController(on: MainTabBarViewProtocol?)
...
@testable import SoraPassport
 ...
 class MockNetworkAvailabilityLayerInteractorInputProtocol: NetworkAvailabilityLayerInteractorInputProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_NetworkAvailabilityLayerInteractorInputProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockNetworkAvailabilityLayerInteractorInputProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockNetworkAvailabilityLayerInteractorOutputProtocol: NetworkAvailabilityLayerInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didDecideUnreachableStatusPresentation()
    """,
            parameters: (),
            escapingParameters: (),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    didDecideReachableStatusPresentation()
    """,
            parameters: (),
            escapingParameters: (),
            superclassCall:
     ...
     struct __StubbingProxy_NetworkAvailabilityLayerInteractorOutputProtocol: Cuckoo.StubbingProxy {
        ...
        func didDecideUnreachableStatusPresentation() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockNetworkAvailabilityLayerInteractorOutputProtocol.self, method:
    """
    didDecideUnreachableStatusPresentation()
    """, parameterMatchers: matchers))
        }
 ...
 class MockOnboardingMainViewProtocol: OnboardingMainViewProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_OnboardingMainViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didStartLoading() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockOnboardingMainViewProtocol.self, method:
    """
    didStartLoading()
    """, parameterMatchers: matchers))
        }
...
import SoraFoundation
 ...
 class MockPersonalUpdateViewProtocol: PersonalUpdateViewProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didReceive(viewModels: [InputViewModelProtocol])
    """,
    ...
    return cuckoo_manager.call(
    """
    didCompleteSaving(success: Bool)
    """,
            parameters: (success),
     ...
     struct __StubbingProxy_PersonalUpdateViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didReceive<M1: Cuckoo.Matchable>(viewModels: M1) -> Cuckoo.ProtocolStubNoReturnFunction<([InputViewModelProtocol])> where M1.MatchedType == [InputViewModelProtocol] {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockPersonalUpdateViewProtocol.self, method:
    """
    didReceive(viewModels: [InputViewModelProtocol])
    """, parameterMatchers: matchers))
        }
 ...
 class MockPersonalUpdatePresenterProtocol: PersonalUpdatePresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_PersonalUpdatePresenterProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockPersonalUpdatePresenterProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockPersonalUpdateInteractorInputProtocol: PersonalUpdateInteractorInputProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_PersonalUpdateInteractorInputProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockPersonalUpdateInteractorInputProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
    ...
    """,
     ...
     struct __StubbingProxy_PersonalUpdateInteractorOutputProtocol: Cuckoo.StubbingProxy {
        ...
        func didReceive<M1: Cuckoo.OptionalMatchable>(username: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(String?)> where M1.OptionalMatchedType == String {
            let matchers: [Cuckoo.ParameterMatcher<(String?)>] = [wrap(matchable: username) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockPersonalUpdateInteractorOutputProtocol.self, method:
    """
    didReceive(username: String?)
    """, parameterMatchers: matchers))
        }
 ...
 class MockPersonalUpdateWireframeProtocol: PersonalUpdateWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    close(view: PersonalUpdateViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    """,
     ...
     struct __StubbingProxy_PersonalUpdateWireframeProtocol: Cuckoo.StubbingProxy {
        ...
        func close<M1: Cuckoo.OptionalMatchable>(view: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(PersonalUpdateViewProtocol?)> where M1.OptionalMatchedType == PersonalUpdateViewProtocol {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockPersonalUpdateWireframeProtocol.self, method:
    """
    close(view: PersonalUpdateViewProtocol?)
    """, parameterMatchers: matchers))
        }
...
import UIKit
 ...
 class MockPinSetupViewProtocol: PinSetupViewProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didChangeAccessoryState(enabled: Bool)
    """,
            parameters: (enabled),
    ...
    return cuckoo_manager.call(
    """
    updatePinCodeSymbolsCount(with: Int)
    """,
            parameters: (count),
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.updatePinCodeSymbolsCount(with: count))
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showUpdatePinRequestView())
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.blockUserInputUntil(date: date))
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showLastChanceAlert())
    ...
    """, parameterMatchers: matchers))
        ...
        func updatePinCodeSymbolsCount<M1: Cuckoo.Matchable>(with count: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Int)> where M1.MatchedType == Int {
    ...
    """, parameterMatchers: matchers))
        ...
        func showUpdatePinRequestView() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockPinSetupViewProtocol.self, method:
    """
    showUpdatePinRequestView()
    """, parameterMatchers: matchers))
        ...
        func blockUserInputUntil<M1: Cuckoo.Matchable>(date: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Date)> where M1.MatchedType == Date {
    ...
    """, parameterMatchers: matchers))
        ...
        func showLastChanceAlert() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockPinSetupViewProtocol.self, method:
    """
    showLastChanceAlert()
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func updatePinCodeSymbolsCount<M1: Cuckoo.Matchable>(with count: M1) -> Cuckoo.__DoNotUse<(Int), Void> where M1.MatchedType == Int {
            let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: count) { $0 }]
            return cuckoo_manager.verify(
    """
    updatePinCodeSymbolsCount(with: Int)
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func showUpdatePinRequestView() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    showUpdatePinRequestView()
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func blockUserInputUntil<M1: Cuckoo.Matchable>(date: M1) -> Cuckoo.__DoNotUse<(Date), Void> where M1.MatchedType == Date {
            let matchers: [Cuckoo.ParameterMatcher<(Date)>] = [wrap(matchable: date) { $0 }]
            return cuckoo_manager.verify(
    """
    blockUserInputUntil(date: Date)
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func showLastChanceAlert() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    showLastChanceAlert()
 ...
 class MockPinSetupInteractorOutputProtocol: PinSetupInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didChangeState(from: PinSetupInteractor.PinSetupState)
    """,
            parameters: (from),
    ...
    return cuckoo_manager.call(
    """
    didReceiveConfigError(_: Swift.Error)
    """,
            parameters: (error),
            escapingParameters: (error),
            superclassCall:
    ...
    """, parameterMatchers: matchers))
        ...
        func didReceiveConfigError<M1: Cuckoo.Matchable>(_ error: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Swift.Error)> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockPinSetupInteractorOutputProtocol.self, method:
    """
    didReceiveConfigError(_: Swift.Error)
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func didReceiveConfigError<M1: Cuckoo.Matchable>(_ error: M1) -> Cuckoo.__DoNotUse<(Swift.Error), Void> where M1.MatchedType == Swift.Error {
            let matchers: [Cuckoo.ParameterMatcher<(Swift.Error)>] = [wrap(matchable: error) { $0 }]
            return cuckoo_manager.verify(
    """
    didReceiveConfigError(_: Swift.Error)
 ...
 class MockPinUpdatable: PinUpdatable, Cuckoo.ProtocolMock {
    
     typealias MocksType = PinUpdatable
    
     typealias Stubbing = __StubbingProxy_PinUpdatable
     typealias Verification = __VerificationProxy_PinUpdatable

     let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: false)

    
    private var __defaultImplStub: PinUpdatable?

     func enableDefaultImplementation(_ stub: PinUpdatable) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    return cuckoo_manager.call(
    """
    showUpdatePinView(from: UIViewController, with: @escaping () -> Void)
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showUpdatePinView(from: view, with: completion))
        
    }
    
    

     struct __StubbingProxy_PinUpdatable: Cuckoo.StubbingProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        ...
        func showUpdatePinView<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from view: M1, with completion: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(UIViewController, () -> Void)> where M1.MatchedType == UIViewController, M2.MatchedType == () -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(UIViewController, () -> Void)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: completion) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockPinUpdatable.self, method:
    """
    showUpdatePinView(from: UIViewController, with: @escaping () -> Void)
    """, parameterMatchers: matchers))
        }
     ...
     struct __VerificationProxy_PinUpdatable: Cuckoo.VerificationProxy {
        private let cuckoo_manager: Cuckoo.MockManager
        private let callMatcher: Cuckoo.CallMatcher
        private let sourceLocation: Cuckoo.SourceLocation
        ...
        @discardableResult
        func showUpdatePinView<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(from view: M1, with completion: M2) -> Cuckoo.__DoNotUse<(UIViewController, () -> Void), Void> where M1.MatchedType == UIViewController, M2.MatchedType == () -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(UIViewController, () -> Void)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: completion) { $0.1 }]
            return cuckoo_manager.verify(
    """
    showUpdatePinView(from: UIViewController, with: @escaping () -> Void)
 ...
 class PinUpdatableStub: PinUpdatable {
 ...
 class MockPinSetupWireframeProtocol: PinSetupWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    dismiss(from: PinSetupViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    showPinUpdatedNotify(from: PinSetupViewProtocol?, completionBlock: @escaping () -> Void)
    """,
...
import Foundation
 ...
 class MockProfileViewProtocol: ProfileViewProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didLoad(optionsViewModels: [ProfileOptionsHeaderViewModelProtocol])
    """,
            parameters: (optionsViewModels),
            escapingParameters: (optionsViewModels),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.didLoad(optionsViewModels: optionsViewModels))
     ...
     struct __StubbingProxy_ProfileViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didLoad<M1: Cuckoo.Matchable>(optionsViewModels: M1) -> Cuckoo.ProtocolStubNoReturnFunction<([ProfileOptionsHeaderViewModelProtocol])> where M1.MatchedType == [ProfileOptionsHeaderViewModelProtocol] {
            let matchers: [Cuckoo.ParameterMatcher<([ProfileOptionsHeaderViewModelProtocol])>] = [wrap(matchable: optionsViewModels) { $0 }]
    ...
    """, parameterMatchers: matchers))
     ...
     struct __VerificationProxy_ProfileViewProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func didLoad<M1: Cuckoo.Matchable>(optionsViewModels: M1) -> Cuckoo.__DoNotUse<([ProfileOptionsHeaderViewModelProtocol]), Void> where M1.MatchedType == [ProfileOptionsHeaderViewModelProtocol] {
            let matchers: [Cuckoo.ParameterMatcher<([ProfileOptionsHeaderViewModelProtocol])>] = [wrap(matchable: optionsViewModels) { $0 }]
            return cuckoo_manager.verify(
    """
    didLoad(optionsViewModels: [ProfileOptionsHeaderViewModelProtocol])
 ...
 class MockProfileInteractorInputProtocol: ProfileInteractorInputProtocol, Cuckoo.ProtocolMock {
    ...
    private var __defaultImplStub: ProfileInteractorInputProtocol?
     ...
     var isThereEntropy: Bool {
        get {
            return cuckoo_manager.getter("isThereEntropy",
                superclassCall:
                    
                    Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                    ,
                defaultCall: __defaultImplStub!.isThereEntropy)
        }
    ...
    return cuckoo_manager.call(
    """
    getCurrentNodeName(completion: @escaping (String) -> Void)
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.getCurrentNodeName(completion: completion))
    ...
    return cuckoo_manager.call(
    """
    isLastAccountWithCustomNodes(completion: @escaping (Bool) -> Void)
    """,
            parameters: (completion),
            escapingParameters: (completion),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.isLastAccountWithCustomNodes(completion: completion))
     ...
     struct __StubbingProxy_ProfileInteractorInputProtocol: Cuckoo.StubbingProxy {
        ...
        var isThereEntropy: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockProfileInteractorInputProtocol, Bool> {
            return .init(manager: cuckoo_manager, name: "isThereEntropy")
        }
    ...
    """, parameterMatchers: matchers))
        ...
        func getCurrentNodeName<M1: Cuckoo.Matchable>(completion: M1) -> Cuckoo.ProtocolStubNoReturnFunction<((String) -> Void)> where M1.MatchedType == (String) -> Void {
    ...
    """, parameterMatchers: matchers))
        ...
        func isLastAccountWithCustomNodes<M1: Cuckoo.Matchable>(completion: M1) -> Cuckoo.ProtocolStubNoReturnFunction<((Bool) -> Void)> where M1.MatchedType == (Bool) -> Void {
    ...
    """, parameterMatchers: matchers))
     ...
     struct __VerificationProxy_ProfileInteractorInputProtocol: Cuckoo.VerificationProxy {
        ...
        var isThereEntropy: Cuckoo.VerifyReadOnlyProperty<Bool> {
            return .init(manager: cuckoo_manager, name: "isThereEntropy", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func getCurrentNodeName<M1: Cuckoo.Matchable>(completion: M1) -> Cuckoo.__DoNotUse<((String) -> Void), Void> where M1.MatchedType == (String) -> Void {
            let matchers: [Cuckoo.ParameterMatcher<((String) -> Void)>] = [wrap(matchable: completion) { $0 }]
            return cuckoo_manager.verify(
    """
    getCurrentNodeName(completion: @escaping (String) -> Void)
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func isLastAccountWithCustomNodes<M1: Cuckoo.Matchable>(completion: M1) -> Cuckoo.__DoNotUse<((Bool) -> Void), Void> where M1.MatchedType == (Bool) -> Void {
            let matchers: [Cuckoo.ParameterMatcher<((Bool) -> Void)>] = [wrap(matchable: completion) { $0 }]
            return cuckoo_manager.verify(
    """
    isLastAccountWithCustomNodes(completion: @escaping (Bool) -> Void)
 ...
 class MockProfileInteractorOutputProtocol: ProfileInteractorOutputProtocol, Cuckoo.ProtocolMock {
    ...
    """,
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.updateScreen())
    ...
    """, parameterMatchers: matchers))
        ...
        func updateScreen() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockProfileInteractorOutputProtocol.self, method:
    """
    updateScreen()
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func updateScreen() -> Cuckoo.__DoNotUse<(), Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return cuckoo_manager.verify(
    """
    updateScreen()
 ...
 class MockProfileWireframeProtocol: ProfileWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    showChangeAccountView(from: ProfileViewProtocol?, completion: @escaping () -> Void)
    """,
            parameters: (view, completion),
            escapingParameters: (view, completion),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showChangeAccountView(from: view, completion: completion))
    ...
    return cuckoo_manager.call(
    """
    showPersonalDetailsView(from: ProfileViewProtocol?, completion: @escaping () -> Void)
    """,
            parameters: (view, completion),
            escapingParameters: (view, completion),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showPersonalDetailsView(from: view, completion: completion))
    ...
    return cuckoo_manager.call(
    """
    showFriendsView(from: ProfileViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    showPassphraseView(from: ProfileViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    showChangePin(from: ProfileViewProtocol)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    showFaq(from: ProfileViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    showDisclaimer(from: ProfileViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
    ...
    return cuckoo_manager.call(
    """
    showLogout(from: ProfileViewProtocol?, isNeedCustomNodeText: Bool, completionBlock: (() -> Void)?)
    """,
            parameters: (view, isNeedCustomNodeText, completionBlock),
            escapingParameters: (view, isNeedCustomNodeText, completionBlock),
            superclassCall:
                
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showLogout(from: view, isNeedCustomNodeText: isNeedCustomNodeText, completionBlock: completionBlock))
    ...
    return cuckoo_manager.call(
    """
    showNodes(from: ProfileViewProtocol?)
    """,
            parameters: (view),
            escapingParameters: (view),
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.showNodes(from: view))
    ...
    return cuckoo_manager.call(
    """
    switchBiometry(toValue: Bool, from: ProfileViewProtocol?, successBlock: @escaping (Bool) -> Void)
    """,
    ...
    """,
     ...
     struct __StubbingProxy_ProfileWireframeProtocol: Cuckoo.StubbingProxy {
        ...
        func showChangeAccountView<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.Matchable>(from view: M1, completion: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(ProfileViewProtocol?, () -> Void)> where M1.OptionalMatchedType == ProfileViewProtocol, M2.MatchedType == () -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?, () -> Void)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: completion) { $0.1 }]
    ...
    """, parameterMatchers: matchers))
        ...
        func showPersonalDetailsView<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.Matchable>(from view: M1, completion: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(ProfileViewProtocol?, () -> Void)> where M1.OptionalMatchedType == ProfileViewProtocol, M2.MatchedType == () -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?, () -> Void)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: completion) { $0.1 }]
            return .init(stub: cuckoo_manager.createStub(for: MockProfileWireframeProtocol.self, method:
    """
    showPersonalDetailsView(from: ProfileViewProtocol?, completion: @escaping () -> Void)
    ...
    """, parameterMatchers: matchers))
        ...
        func showChangePin<M1: Cuckoo.Matchable>(from view: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(ProfileViewProtocol)> where M1.MatchedType == ProfileViewProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol)>] = [wrap(matchable: view) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockProfileWireframeProtocol.self, method:
    """
    showChangePin(from: ProfileViewProtocol)
    ...
    """, parameterMatchers: matchers))
        ...
        func showLogout<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable>(from view: M1, isNeedCustomNodeText: M2, completionBlock: M3) -> Cuckoo.ProtocolStubNoReturnFunction<(ProfileViewProtocol?, Bool, (() -> Void)?)> where M1.OptionalMatchedType == ProfileViewProtocol, M2.MatchedType == Bool, M3.OptionalMatchedType == (() -> Void) {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?, Bool, (() -> Void)?)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: isNeedCustomNodeText) { $0.1 }, wrap(matchable: completionBlock) { $0.2 }]
            return .init(stub: cuckoo_manager.createStub(for: MockProfileWireframeProtocol.self, method:
    """
    showLogout(from: ProfileViewProtocol?, isNeedCustomNodeText: Bool, completionBlock: (() -> Void)?)
    """, parameterMatchers: matchers))
        ...
        func showNodes<M1: Cuckoo.OptionalMatchable>(from view: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(ProfileViewProtocol?)> where M1.OptionalMatchedType == ProfileViewProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?)>] = [wrap(matchable: view) { $0 }]
            return .init(stub: cuckoo_manager.createStub(for: MockProfileWireframeProtocol.self, method:
    """
    showNodes(from: ProfileViewProtocol?)
    ...
    """, parameterMatchers: matchers))
     ...
     struct __VerificationProxy_ProfileWireframeProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func showChangeAccountView<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.Matchable>(from view: M1, completion: M2) -> Cuckoo.__DoNotUse<(ProfileViewProtocol?, () -> Void), Void> where M1.OptionalMatchedType == ProfileViewProtocol, M2.MatchedType == () -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?, () -> Void)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: completion) { $0.1 }]
            return cuckoo_manager.verify(
    """
    showChangeAccountView(from: ProfileViewProtocol?, completion: @escaping () -> Void)
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func showPersonalDetailsView<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.Matchable>(from view: M1, completion: M2) -> Cuckoo.__DoNotUse<(ProfileViewProtocol?, () -> Void), Void> where M1.OptionalMatchedType == ProfileViewProtocol, M2.MatchedType == () -> Void {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?, () -> Void)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: completion) { $0.1 }]
            return cuckoo_manager.verify(
    """
    showPersonalDetailsView(from: ProfileViewProtocol?, completion: @escaping () -> Void)
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func showChangePin<M1: Cuckoo.Matchable>(from view: M1) -> Cuckoo.__DoNotUse<(ProfileViewProtocol), Void> where M1.MatchedType == ProfileViewProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol)>] = [wrap(matchable: view) { $0 }]
            return cuckoo_manager.verify(
    """
    showChangePin(from: ProfileViewProtocol)
    ...
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func showLogout<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.Matchable, M3: Cuckoo.OptionalMatchable>(from view: M1, isNeedCustomNodeText: M2, completionBlock: M3) -> Cuckoo.__DoNotUse<(ProfileViewProtocol?, Bool, (() -> Void)?), Void> where M1.OptionalMatchedType == ProfileViewProtocol, M2.MatchedType == Bool, M3.OptionalMatchedType == (() -> Void) {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?, Bool, (() -> Void)?)>] = [wrap(matchable: view) { $0.0 }, wrap(matchable: isNeedCustomNodeText) { $0.1 }, wrap(matchable: completionBlock) { $0.2 }]
            return cuckoo_manager.verify(
    """
    showLogout(from: ProfileViewProtocol?, isNeedCustomNodeText: Bool, completionBlock: (() -> Void)?)
    """, callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
        ...
        @discardableResult
        func showNodes<M1: Cuckoo.OptionalMatchable>(from view: M1) -> Cuckoo.__DoNotUse<(ProfileViewProtocol?), Void> where M1.OptionalMatchedType == ProfileViewProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(ProfileViewProtocol?)>] = [wrap(matchable: view) { $0 }]
            return cuckoo_manager.verify(
    """
    showNodes(from: ProfileViewProtocol?)
    ...
    """,
     ...
     struct __StubbingProxy_RootInteractorOutputProtocol: Cuckoo.StubbingProxy {
        ...
        func didDecideOnboarding() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockRootInteractorOutputProtocol.self, method:
    """
    didDecideOnboarding()
    """, parameterMatchers: matchers))
        }
 ...
 class MockSecurityLayerInteractorInputProtocol: SecurityLayerInteractorInputProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_SecurityLayerInteractorInputProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockSecurityLayerInteractorInputProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
    ...
    """,
     ...
     struct __StubbingProxy_SecurityLayerInteractorOutputProtocol: Cuckoo.StubbingProxy {
        ...
        func didDecideSecurePresentation() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockSecurityLayerInteractorOutputProtocol.self, method:
    """
    didDecideSecurePresentation()
    """, parameterMatchers: matchers))
        }
    ...
    """,
     ...
     struct __StubbingProxy_SecurityLayerWireframProtocol: Cuckoo.StubbingProxy {
        ...
        func showSecuringOverlay() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockSecurityLayerWireframProtocol.self, method:
    """
    showSecuringOverlay()
    """, parameterMatchers: matchers))
        }
...
import UIKit
 ...
 class MockUnsupportedVersionViewProtocol: UnsupportedVersionViewProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call(
    """
    didReceive(viewModel: UnsupportedVersionViewModel)
    """,
            parameters: (viewModel),
            escapingParameters: (viewModel),
            superclassCall:
     ...
     struct __StubbingProxy_UnsupportedVersionViewProtocol: Cuckoo.StubbingProxy {
        ...
        func didReceive<M1: Cuckoo.Matchable>(viewModel: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(UnsupportedVersionViewModel)> where M1.MatchedType == UnsupportedVersionViewModel {
            ...
            return .init(stub: cuckoo_manager.createStub(for: MockUnsupportedVersionViewProtocol.self, method:
    """
    didReceive(viewModel: UnsupportedVersionViewModel)
    """, parameterMatchers: matchers))
        }
 ...
 class MockUnsupportedVersionPresenterProtocol: UnsupportedVersionPresenterProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_UnsupportedVersionPresenterProtocol: Cuckoo.StubbingProxy {
        ...
        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
            return .init(stub: cuckoo_manager.createStub(for: MockUnsupportedVersionPresenterProtocol.self, method:
    """
    setup()
    """, parameterMatchers: matchers))
        }
 ...
 class MockUnsupportedVersionWireframeProtocol: UnsupportedVersionWireframeProtocol, Cuckoo.ProtocolMock {
    ...
    """,
     ...
     struct __StubbingProxy_UnsupportedVersionWireframeProtocol: Cuckoo.StubbingProxy {
        ...
        func present<M1: Cuckoo.OptionalMatchable, M2: Cuckoo.OptionalMatchable, M3: Cuckoo.OptionalMatchable, M4: Cuckoo.OptionalMatchable>(message: M1, title: M2, closeAction: M3, from view: M4) -> Cuckoo.ProtocolStubNoReturnFunction<(String?, String?, String?, ControllerBackedProtocol?)> where M1.OptionalMatchedType == String, M2.OptionalMatchedType == String, M3.OptionalMatchedType == String, M4.OptionalMatchedType == ControllerBackedProtocol {
            let matchers: [Cuckoo.ParameterMatcher<(String?, String?, String?, ControllerBackedProtocol?)>] = [wrap(matchable: message) { $0.0 }, wrap(matchable: title) { $0.1 }, wrap(matchable: closeAction) { $0.2 }, wrap(matchable: view) { $0.3 }]
            return .init(stub: cuckoo_manager.createStub(for: MockUnsupportedVersionWireframeProtocol.self, method:
    """
    present(message: String?, title: String?, closeAction: String?, from: ControllerBackedProtocol?)
    """, parameterMatchers: matchers))
        }
