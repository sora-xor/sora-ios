...
class ProjectUnitFundingServiceTests: NetworkBaseTests {
    ...
    func testFetchProjectsSuccess() {
        ...
        // when
        let operation = try? service.fetchAllProjects(with: OffsetPagination(offset: 0, count: 10), runCompletionIn: .main) { (optionalResult) in
            defer {
                expectation.fulfill()
            }
    ...
    func testFetchFavoriteProjectsSuccess() {
        ...
        // when
        let operation = try? service.fetchFavoriteProjects(with: OffsetPagination(offset: 0, count: 10), runCompletionIn: .main) { (optionalResult) in
            defer {
                expectation.fulfill()
            }
    ...
    func testFetchVotedProjectsSuccess() {
        ...
        // when
        let operation = try? service.fetchVotedProjects(with: OffsetPagination(offset: 0, count: 10), runCompletionIn: .main) { (optionalResult) in
            defer {
                expectation.fulfill()
            }
    ...
    func testFetchFinishedProjectsSuccess() {
        ...
        // when
        let operation = try? service.fetchFinishedProjects(with: OffsetPagination(offset: 0, count: 10), runCompletionIn: .main) { (optionalResult) in
            defer {
                expectation.fulfill()
            }
    ...
    func testVotesHistoryFetchSuccess() {
        ...
        // when
        let votesHistoryInfo = OffsetPagination(offset: 0, count: 50)
