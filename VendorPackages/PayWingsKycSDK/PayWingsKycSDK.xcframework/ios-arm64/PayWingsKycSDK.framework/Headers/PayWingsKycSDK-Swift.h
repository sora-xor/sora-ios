...
#ifndef PAYWINGSKYCSDK_SWIFT_H
#define PAYWINGSKYCSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayWingsKycSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14PayWingsKycSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsKycSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsKycSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsKycSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsKycSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC14PayWingsKycSDK11SumSubTheme")
