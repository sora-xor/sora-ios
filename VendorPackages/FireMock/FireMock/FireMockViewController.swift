...
public class FireMockViewController: UIViewController {
    ...
    private func registerXib() {
        let nib = UINib(nibName: "FireMockTableViewCell", bundle: FireMockResources.bundle)
        tableView.register(nib, forCellReuseIdentifier: "FireMockTableViewCell")

        let nibHeader = UINib(nibName: "FireMockTableViewHeaderCell", bundle: FireMockResources.bundle)
...
extension FireMockViewController: UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if configMock.mocks.count > 1 {
            let mockSelectionController = FireMockSelectionTableViewController(nibName: "FireMockSelectionTableViewController", bundle: FireMockResources.bundle)
