...
public extension UIView {
	...
	func pinToSuperView(insets: SoramitsuInsets, respectingSafeArea: Bool = true) {
		...
		let top = respectingSafeArea ? superview.soraSafeTopAnchor : superview.topAnchor
		let leading = respectingSafeArea ? superview.soraSafeLeadingAnchor : superview.leadingAnchor
		let trailing = respectingSafeArea ? superview.soraSafeTrailingAnchor : superview.trailingAnchor
		let bottom = respectingSafeArea ? superview.soraSafeBottomAnchor : superview.bottomAnchor
...
public extension UIView {
	...
	var soraSafeTopAnchor: NSLayoutYAxisAnchor {
		return safeAreaLayoutGuide.topAnchor
	}

	var soraSafeBottomAnchor: NSLayoutYAxisAnchor {
		return safeAreaLayoutGuide.bottomAnchor
	}

	var soraSafeLeadingAnchor: NSLayoutXAxisAnchor {
		return safeAreaLayoutGuide.leadingAnchor
	}

	var soraSafeTrailingAnchor: NSLayoutXAxisAnchor {
