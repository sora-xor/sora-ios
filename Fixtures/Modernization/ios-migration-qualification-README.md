...
That gate requires exactly 94 passing migration tests across the projector (30), installable clone
(3), exact-IPA controller (24), `.xctestrun` sanitizer (6), collector (16), and Release boundary
(15), plus 7 internal-TestFlight, 17 Release-package, 15 Taira-admission, 10 vendored-binary,
10 signing-identity, and 20 production-promotion tests. It executes the thirteen
