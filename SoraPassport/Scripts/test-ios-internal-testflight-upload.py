    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026091401",
            ...
            "CURRENT_PROJECT_VERSION": "2026091401",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="c593a5a3536f86d6317a1b107b03f3f47f9db591"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026091401"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026091401",
            "c593a5a3536f86d6317a1b107b03f3f47f9db591",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026091401",
