    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026090701",
            ...
            "CURRENT_PROJECT_VERSION": "2026090701",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="2a1ee11b77938886a95751946469c15ce10b8dd8"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026090701"',
            'reviewed_build_number="2026090701"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026090701",
            "2a1ee11b77938886a95751946469c15ce10b8dd8",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026090701",
