    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026090802",
            ...
            "CURRENT_PROJECT_VERSION": "2026090802",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="95d33aad697f476c6d8170e4a4303df779b3cc8b"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026090802"',
            'reviewed_build_number="2026090802"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026090802",
            "95d33aad697f476c6d8170e4a4303df779b3cc8b",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026090802",
