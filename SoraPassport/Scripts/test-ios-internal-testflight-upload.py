    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026091305",
            ...
            "CURRENT_PROJECT_VERSION": "2026091305",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="ec3c07f2c6ffaddbfff8c2983a63214718c519a8"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026091305-r2"',
            'reviewed_build_number="2026091305"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026091305-r2",
            "ec3c07f2c6ffaddbfff8c2983a63214718c519a8",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026091305",
