    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026091304",
            ...
            "CURRENT_PROJECT_VERSION": "2026091304",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="a472679a10beb1cc71468bcf25d7f57ac541c744"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026091304"',
            'reviewed_build_number="2026091304"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026091304",
            "a472679a10beb1cc71468bcf25d7f57ac541c744",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026091304",
