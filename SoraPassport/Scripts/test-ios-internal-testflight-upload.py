    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026091302",
            ...
            "CURRENT_PROJECT_VERSION": "2026091302",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="b3a4a41dc740506a16823d7eca1a57ce082ae469"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026091302"',
            'reviewed_build_number="2026091302"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026091302",
            "b3a4a41dc740506a16823d7eca1a57ce082ae469",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026091302",
