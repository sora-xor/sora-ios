    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026090801",
            ...
            "CURRENT_PROJECT_VERSION": "2026090801",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="b82a225bad3af795de2997ae74f781a9744bd593"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026090801"',
            'reviewed_build_number="2026090801"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026090801",
            "b82a225bad3af795de2997ae74f781a9744bd593",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026090801",
