    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026082004",
            ...
            "SORA_TAIRA_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026082004",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "d6bb388235a3c5b9350d7d8cddf403874ceb2935",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026082004",
...
""".format(profile_path=reviewed_profile)
    ...
    def test_wrapper_rejects_unreviewed_build_before_xcode(self) -> None:
        ...
        for stale_value in ("2026082002", "2026082001"):
