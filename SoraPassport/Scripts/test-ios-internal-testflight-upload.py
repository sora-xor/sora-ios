    ...
    environment.update(
        {
            ...
            "SORA_IOS_INTERNAL_TESTFLIGHT_BUILD_NUMBER": "2026091303",
            ...
            "CURRENT_PROJECT_VERSION": "2026091303",
...
class InternalTestFlightUploadTests(unittest.TestCase):
    ...
    def test_wrapper_binds_source_and_stays_non_authorizing(self) -> None:
        ...
        for marker in (
            ...
            "rev-parse '@{upstream}'",
            'reviewed_base_revision="204ee5a7bbc58fc7d3b88d429bfc2198ad79e2fa"',
            'reviewed_upstream="origin/codex/ios-wallet-upgrade-testflight-2026091303"',
            'reviewed_build_number="2026091303"',
        ...
        for marker in (
            ...
            "origin/codex/ios-wallet-upgrade-testflight-2026091303",
            "204ee5a7bbc58fc7d3b88d429bfc2198ad79e2fa",
            ...
            "Distributions": [
                {
                    ...
                    "uploadedBuildNumber": "2026091303",
