...
protocol ProjectImageViewModelProtocol: class {
...
final class ProjectImageViewModel: NSObject {
    private var url: URL
...
extension ProjectImageViewModel: ProjectImageViewModelProtocol {
    var image: UIImage? {
...
extension ProjectImageViewModel: ImageProcessor {
