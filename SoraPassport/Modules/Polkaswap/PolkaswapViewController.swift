...
final class PolkaswapViewController: UIViewController {
    var presenter: PolkaswapPresenterProtocol!
    ...
    private func reloadData() {
        ...
        linkView.do {
            ...
            $0.iconTintColor = R.color.brandPolkaswapPink()
...
extension PolkaswapViewController: PolkaswapViewProtocol {
    func didReceive(viewModel: ComingSoonViewModel) {
        self.viewModel = viewModel
    }
}

extension PolkaswapViewController: Localizable {
