...
final class ContactTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        selectedBackgroundView.backgroundColor = R.color.baseBackgroundHover()!.withAlphaComponent(0.3)
    ...
    private func setupTitleLabel() {
        ...
        titleLabel.font = UIFont.styled(for: .paragraph3)
    ...
    private func setupSubtitleLabel() {
        ...
        let label = UILabel()
        label.textColor = R.color.baseContentSecondary()
