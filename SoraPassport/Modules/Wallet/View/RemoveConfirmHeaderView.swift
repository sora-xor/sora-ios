...
final class RemoveConfirmHeaderView: UIView, WalletFormBordering {
    ...
    @IBOutlet private(set) var willReceiveLabel: UILabel!
...
//        self.assetLabel.font = UIFont.styled(for: .display2, isBold: true)
    ...
    func bind(viewModel: SoraRemoveLiquidityHeaderViewModel) {
        willReceiveLabel.text = R.string.localizable.commonYouWillReceive(preferredLanguages: .currentLocale)
