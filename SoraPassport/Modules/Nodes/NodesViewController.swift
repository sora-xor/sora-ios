...
extension NodesViewController: NodesViewProtocol {
    ...
    private func setupNavbar() {
        ...
        let addButton = UIBarButtonItem(title: R.string.localizable.selectNodeAddNode(), style: .plain, target: self, action: #selector(editTapped))
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            tableView.topAnchor.constraint(equalTo: view.gSafeTopAnchor),
            tableView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            tableView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            tableView.bottomAnchor.constraint(equalTo: view.gSafeBottomAnchor)
        ])
    }
