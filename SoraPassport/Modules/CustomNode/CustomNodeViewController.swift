...
final class CustomNodeViewController: BlurViewController, AlertPresentable {
...
private extension CustomNodeViewController {
    ...
    func configureNew() {
        ...
        containerView.do {
            $0.topAnchor == view.gSafeTopAnchor + 8
            $0.bottomAnchor <= view.gSafeBottomAnchor
    ...
    private func setupLocalization() {
        ...
        nodeNameTextField.sora.textFieldPlaceholder = R.string.localizable.selectNodeNodeName(preferredLanguages: languages)
        nodeAddressTextField.sora.textFieldPlaceholder = R.string.localizable.selectNodeNodeAddress(preferredLanguages: languages)
